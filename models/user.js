...
userSchema.methods.addToCart = function(product) {
  ...
  userSchema.methods.addToWishlist = function(product) {
    const wishlistProductIndex = this.wishlist.items.findIndex(wl => {
      return wl.productId.toString() === product._id.toString();
    });
  ...
  userSchema.methods.removeFromWishlist = function(prodId) {
